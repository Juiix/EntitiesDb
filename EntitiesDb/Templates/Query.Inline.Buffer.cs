...
public partial class Query
{
	...
	public void InlineBuffer<T, T0, T1>(ref T forEach)
	...
	/// <inheritdoc cref="InlineBuffer{T, T0}(ref T)"/>
	public void InlineBuffer<T, T0, T1, T2>(ref T forEach)
	...
	/// <inheritdoc cref="InlineBuffer{T, T0}(ref T)"/>
	public void InlineBuffer<T, T0, T1, T2, T3>(ref T forEach)
	...
	/// <inheritdoc cref="InlineBuffer{T, T0}(ref T)"/>
	public void InlineBuffer<T, T0, T1, T2, T3, T4>(ref T forEach)
	...
	/// <inheritdoc cref="InlineBuffer{T, T0}(ref T)"/>
	public void InlineBuffer<T, T0, T1, T2, T3, T4, T5>(ref T forEach)
	...
	/// <inheritdoc cref="InlineBuffer{T, T0}(ref T)"/>
	public void InlineBuffer<T, T0, T1, T2, T3, T4, T5, T6>(ref T forEach)
	...
	/// <inheritdoc cref="InlineBuffer{T, T0}(ref T)"/>
	public void InlineBuffer<T, T0, T1, T2, T3, T4, T5, T6, T7>(ref T forEach)
	...
	/// <inheritdoc cref="InlineBuffer{T, T0}(ref T)"/>
	public void InlineBuffer<T, T0, T1, T2, T3, T4, T5, T6, T7, T8>(ref T forEach)
	...
	/// <inheritdoc cref="InlineBuffer{T, T0}(ref T)"/>
	public void InlineBuffer<T, T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>(ref T forEach)
	...
	/// <inheritdoc cref="InlineBuffer{T, T0}(ref T)"/>
	public void InlineBuffer<T, T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(ref T forEach)
	...
	/// <inheritdoc cref="InlineBuffer{T, T0}(ref T)"/>
	public void InlineBuffer<T, T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(ref T forEach)
	...
	/// <inheritdoc cref="InlineBuffer{T, T0}(ref T)"/>
	public void InlineBuffer<T, T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>(ref T forEach)
	...
	/// <inheritdoc cref="InlineBuffer{T, T0}(ref T)"/>
	public void InlineBuffer<T, T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>(ref T forEach)
	...
	/// <inheritdoc cref="InlineBuffer{T, T0}(ref T)"/>
	public void InlineBuffer<T, T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>(ref T forEach)
	...
	/// <inheritdoc cref="InlineBuffer{T, T0}(ref T)"/>
	public void InlineBuffer<T, T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15>(ref T forEach)
