...
public partial class Archetype
{
	...
	internal void Set<T0, T1>(in EntitySlot slot, in ComponentIds<T0, T1> ids, in T0? t0Component = default, in T1? t1Component = default)
	{
	...
	/// <inheritdoc cref="Set{T0}(in EntitySlot, in ComponentIds{T0}, in T0?)"/>
	internal void Set<T0, T1, T2>(in EntitySlot slot, in ComponentIds<T0, T1, T2> ids, in T0? t0Component = default, in T1? t1Component = default, in T2? t2Component = default)
	{
		ref var chunk = ref _chunks[slot.ChunkIndex];
		chunk.Set(slot.Index, ids.T0, in t0Component);
        chunk.Set(slot.Index, ids.T1, in t1Component);
	...
	/// <inheritdoc cref="Set{T0}(in EntitySlot, in ComponentIds{T0}, in T0?)"/>
	internal void Set<T0, T1, T2, T3>(in EntitySlot slot, in ComponentIds<T0, T1, T2, T3> ids, in T0? t0Component = default, in T1? t1Component = default, in T2? t2Component = default, in T3? t3Component = default)
	{
		ref var chunk = ref _chunks[slot.ChunkIndex];
		chunk.Set(slot.Index, ids.T0, in t0Component);
        chunk.Set(slot.Index, ids.T1, in t1Component);
	...
	/// <inheritdoc cref="Set{T0}(in EntitySlot, in ComponentIds{T0}, in T0?)"/>
	internal void Set<T0, T1, T2, T3, T4>(in EntitySlot slot, in ComponentIds<T0, T1, T2, T3, T4> ids, in T0? t0Component = default, in T1? t1Component = default, in T2? t2Component = default, in T3? t3Component = default, in T4? t4Component = default)
	{
		ref var chunk = ref _chunks[slot.ChunkIndex];
		chunk.Set(slot.Index, ids.T0, in t0Component);
        chunk.Set(slot.Index, ids.T1, in t1Component);
	...
	/// <inheritdoc cref="Set{T0}(in EntitySlot, in ComponentIds{T0}, in T0?)"/>
	internal void Set<T0, T1, T2, T3, T4, T5>(in EntitySlot slot, in ComponentIds<T0, T1, T2, T3, T4, T5> ids, in T0? t0Component = default, in T1? t1Component = default, in T2? t2Component = default, in T3? t3Component = default, in T4? t4Component = default, in T5? t5Component = default)
	{
		ref var chunk = ref _chunks[slot.ChunkIndex];
		chunk.Set(slot.Index, ids.T0, in t0Component);
        chunk.Set(slot.Index, ids.T1, in t1Component);
	...
	/// <inheritdoc cref="Set{T0}(in EntitySlot, in ComponentIds{T0}, in T0?)"/>
	internal void Set<T0, T1, T2, T3, T4, T5, T6>(in EntitySlot slot, in ComponentIds<T0, T1, T2, T3, T4, T5, T6> ids, in T0? t0Component = default, in T1? t1Component = default, in T2? t2Component = default, in T3? t3Component = default, in T4? t4Component = default, in T5? t5Component = default, in T6? t6Component = default)
	{
		ref var chunk = ref _chunks[slot.ChunkIndex];
		chunk.Set(slot.Index, ids.T0, in t0Component);
        chunk.Set(slot.Index, ids.T1, in t1Component);
