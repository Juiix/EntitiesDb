...
internal static class TypeUtils
{
	...
	/// <summary>
	/// Returns true if <typeparamref name="T"/> is an unmanaged type
	/// </summary>
	...
	/// <summary>
	/// Returns true if <typeparamref name="T"/> has <see cref="TrackChangesAttribute"/>
	/// </summary>
	/// <typeparam name="T"></typeparam>
	/// <returns></returns>
	public static bool ShouldTrackChanges<T>()
	{
		var attribute = typeof(T).GetCustomAttribute<TrackChangesAttribute>();
