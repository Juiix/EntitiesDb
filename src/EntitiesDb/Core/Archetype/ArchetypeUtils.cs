...
internal unsafe static class ArchetypeUtils
{
	...
	public static short[] BuildIdOffsetLookup(ReadOnlySpan<ComponentType> componentTypes, int unmanagedCount, int chunkCapacity)
	{
		...
		{
			idToOffsets[componentType.Id] = (short)(componentType.IsTag ? -1 : unmanagedEntitySize * chunkCapacity);
	...
	/// <param name="globalChangeVersions"></param>
	/// <returns></returns>
	public static int[] BuildChangeVersions(int[] globalChangeVersions)
	{
