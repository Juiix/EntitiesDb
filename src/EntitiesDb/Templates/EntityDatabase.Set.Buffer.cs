...
public partial class EntityDatabase
{
	...
	/// <inheritdoc cref="Set{T0}(Entity, T0[])"/>
	[ChunkChange]
	...
	/// <inheritdoc cref="Set{T0}(int, T0[])"/>
	[ChunkChange]
	public void Set<T0, T1>(int entityId, T0[] t0Components, T1[] t1Components)
		where T0 : unmanaged
        where T1 : unmanaged
	{
		Set(entityId, t0Components.AsSpan(), t1Components.AsSpan());
	}
	/// <inheritdoc cref="Set{T0}(Entity, ReadOnlySpan{T0})"/>
	[ChunkChange]
	...
	/// <inheritdoc cref="Set{T0}(int, T0[])"/>
	[ChunkChange]
	public void Set<T0, T1, T2>(int entityId, T0[] t0Components, T1[] t1Components, T2[] t2Components)
		where T0 : unmanaged
        where T1 : unmanaged
        where T2 : unmanaged
	{
		Set(entityId, t0Components.AsSpan(), t1Components.AsSpan(), t2Components.AsSpan());
	}
	/// <inheritdoc cref="Set{T0}(Entity, ReadOnlySpan{T0})"/>
	[ChunkChange]
	...
	/// <inheritdoc cref="Set{T0}(int, T0[])"/>
	[ChunkChange]
	public void Set<T0, T1, T2, T3>(int entityId, T0[] t0Components, T1[] t1Components, T2[] t2Components, T3[] t3Components)
		where T0 : unmanaged
        where T1 : unmanaged
        where T2 : unmanaged
        where T3 : unmanaged
	{
		Set(entityId, t0Components.AsSpan(), t1Components.AsSpan(), t2Components.AsSpan(), t3Components.AsSpan());
	}
	/// <inheritdoc cref="Set{T0}(Entity, ReadOnlySpan{T0})"/>
	[ChunkChange]
	...
	/// <inheritdoc cref="Set{T0}(int, T0[])"/>
	[ChunkChange]
	public void Set<T0, T1, T2, T3, T4>(int entityId, T0[] t0Components, T1[] t1Components, T2[] t2Components, T3[] t3Components, T4[] t4Components)
		where T0 : unmanaged
        where T1 : unmanaged
        where T2 : unmanaged
        where T3 : unmanaged
        where T4 : unmanaged
	{
		Set(entityId, t0Components.AsSpan(), t1Components.AsSpan(), t2Components.AsSpan(), t3Components.AsSpan(), t4Components.AsSpan());
	}
	/// <inheritdoc cref="Set{T0}(Entity, ReadOnlySpan{T0})"/>
	[ChunkChange]
	...
	/// <inheritdoc cref="Set{T0}(int, T0[])"/>
	[ChunkChange]
	public void Set<T0, T1, T2, T3, T4, T5>(int entityId, T0[] t0Components, T1[] t1Components, T2[] t2Components, T3[] t3Components, T4[] t4Components, T5[] t5Components)
		where T0 : unmanaged
        where T1 : unmanaged
        where T2 : unmanaged
        where T3 : unmanaged
        ...
        where T5 : unmanaged
	{
		Set(entityId, t0Components.AsSpan(), t1Components.AsSpan(), t2Components.AsSpan(), t3Components.AsSpan(), t4Components.AsSpan(), t5Components.AsSpan());
	}
	/// <inheritdoc cref="Set{T0}(Entity, ReadOnlySpan{T0})"/>
	[ChunkChange]
	...
	/// <inheritdoc cref="Set{T0}(int, T0[])"/>
	[ChunkChange]
	public void Set<T0, T1, T2, T3, T4, T5, T6>(int entityId, T0[] t0Components, T1[] t1Components, T2[] t2Components, T3[] t3Components, T4[] t4Components, T5[] t5Components, T6[] t6Components)
		where T0 : unmanaged
        where T1 : unmanaged
        where T2 : unmanaged
        where T3 : unmanaged
        ...
        where T6 : unmanaged
	{
		Set(entityId, t0Components.AsSpan(), t1Components.AsSpan(), t2Components.AsSpan(), t3Components.AsSpan(), t4Components.AsSpan(), t5Components.AsSpan(), t6Components.AsSpan());
	}
	/// <inheritdoc cref="Set{T0}(Entity, ReadOnlySpan{T0})"/>
	[ChunkChange]
	...
	/// <inheritdoc cref="Set{T0}(int, T0[])"/>
	[ChunkChange]
	public void Set<T0, T1, T2, T3, T4, T5, T6, T7>(int entityId, T0[] t0Components, T1[] t1Components, T2[] t2Components, T3[] t3Components, T4[] t4Components, T5[] t5Components, T6[] t6Components, T7[] t7Components)
		where T0 : unmanaged
        where T1 : unmanaged
        where T2 : unmanaged
        where T3 : unmanaged
        ...
        where T7 : unmanaged
	{
		Set(entityId, t0Components.AsSpan(), t1Components.AsSpan(), t2Components.AsSpan(), t3Components.AsSpan(), t4Components.AsSpan(), t5Components.AsSpan(), t6Components.AsSpan(), t7Components.AsSpan());
	}
	/// <inheritdoc cref="Set{T0}(Entity, ReadOnlySpan{T0})"/>
	[ChunkChange]
	...
	/// <inheritdoc cref="Set{T0}(int, T0[])"/>
	[ChunkChange]
	public void Set<T0, T1, T2, T3, T4, T5, T6, T7, T8>(int entityId, T0[] t0Components, T1[] t1Components, T2[] t2Components, T3[] t3Components, T4[] t4Components, T5[] t5Components, T6[] t6Components, T7[] t7Components, T8[] t8Components)
		where T0 : unmanaged
        where T1 : unmanaged
        where T2 : unmanaged
        where T3 : unmanaged
        ...
        where T8 : unmanaged
	{
		Set(entityId, t0Components.AsSpan(), t1Components.AsSpan(), t2Components.AsSpan(), t3Components.AsSpan(), t4Components.AsSpan(), t5Components.AsSpan(), t6Components.AsSpan(), t7Components.AsSpan(), t8Components.AsSpan());
	}
	/// <inheritdoc cref="Set{T0}(Entity, ReadOnlySpan{T0})"/>
	[ChunkChange]
	...
	/// <inheritdoc cref="Set{T0}(int, T0[])"/>
	[ChunkChange]
	public void Set<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>(int entityId, T0[] t0Components, T1[] t1Components, T2[] t2Components, T3[] t3Components, T4[] t4Components, T5[] t5Components, T6[] t6Components, T7[] t7Components, T8[] t8Components, T9[] t9Components)
		where T0 : unmanaged
        where T1 : unmanaged
        where T2 : unmanaged
        where T3 : unmanaged
        ...
        where T9 : unmanaged
	{
		Set(entityId, t0Components.AsSpan(), t1Components.AsSpan(), t2Components.AsSpan(), t3Components.AsSpan(), t4Components.AsSpan(), t5Components.AsSpan(), t6Components.AsSpan(), t7Components.AsSpan(), t8Components.AsSpan(), t9Components.AsSpan());
	}
	/// <inheritdoc cref="Set{T0}(Entity, ReadOnlySpan{T0})"/>
	[ChunkChange]
	...
	/// <inheritdoc cref="Set{T0}(int, T0[])"/>
	[ChunkChange]
	public void Set<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(int entityId, T0[] t0Components, T1[] t1Components, T2[] t2Components, T3[] t3Components, T4[] t4Components, T5[] t5Components, T6[] t6Components, T7[] t7Components, T8[] t8Components, T9[] t9Components, T10[] t10Components)
		where T0 : unmanaged
        where T1 : unmanaged
        where T2 : unmanaged
        where T3 : unmanaged
        ...
        where T10 : unmanaged
	{
		Set(entityId, t0Components.AsSpan(), t1Components.AsSpan(), t2Components.AsSpan(), t3Components.AsSpan(), t4Components.AsSpan(), t5Components.AsSpan(), t6Components.AsSpan(), t7Components.AsSpan(), t8Components.AsSpan(), t9Components.AsSpan(), t10Components.AsSpan());
	}
	/// <inheritdoc cref="Set{T0}(Entity, ReadOnlySpan{T0})"/>
	[ChunkChange]
	...
	/// <inheritdoc cref="Set{T0}(int, T0[])"/>
	[ChunkChange]
	public void Set<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(int entityId, T0[] t0Components, T1[] t1Components, T2[] t2Components, T3[] t3Components, T4[] t4Components, T5[] t5Components, T6[] t6Components, T7[] t7Components, T8[] t8Components, T9[] t9Components, T10[] t10Components, T11[] t11Components)
		where T0 : unmanaged
        where T1 : unmanaged
        where T2 : unmanaged
        where T3 : unmanaged
        ...
        where T11 : unmanaged
	{
		Set(entityId, t0Components.AsSpan(), t1Components.AsSpan(), t2Components.AsSpan(), t3Components.AsSpan(), t4Components.AsSpan(), t5Components.AsSpan(), t6Components.AsSpan(), t7Components.AsSpan(), t8Components.AsSpan(), t9Components.AsSpan(), t10Components.AsSpan(), t11Components.AsSpan());
	}
	/// <inheritdoc cref="Set{T0}(Entity, ReadOnlySpan{T0})"/>
	[ChunkChange]
	...
	/// <inheritdoc cref="Set{T0}(int, T0[])"/>
	[ChunkChange]
	public void Set<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>(int entityId, T0[] t0Components, T1[] t1Components, T2[] t2Components, T3[] t3Components, T4[] t4Components, T5[] t5Components, T6[] t6Components, T7[] t7Components, T8[] t8Components, T9[] t9Components, T10[] t10Components, T11[] t11Components, T12[] t12Components)
		where T0 : unmanaged
        where T1 : unmanaged
        where T2 : unmanaged
        where T3 : unmanaged
        ...
        where T12 : unmanaged
	{
		Set(entityId, t0Components.AsSpan(), t1Components.AsSpan(), t2Components.AsSpan(), t3Components.AsSpan(), t4Components.AsSpan(), t5Components.AsSpan(), t6Components.AsSpan(), t7Components.AsSpan(), t8Components.AsSpan(), t9Components.AsSpan(), t10Components.AsSpan(), t11Components.AsSpan(), t12Components.AsSpan());
	}
	/// <inheritdoc cref="Set{T0}(Entity, ReadOnlySpan{T0})"/>
	[ChunkChange]
	...
	/// <inheritdoc cref="Set{T0}(int, T0[])"/>
	[ChunkChange]
	public void Set<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>(int entityId, T0[] t0Components, T1[] t1Components, T2[] t2Components, T3[] t3Components, T4[] t4Components, T5[] t5Components, T6[] t6Components, T7[] t7Components, T8[] t8Components, T9[] t9Components, T10[] t10Components, T11[] t11Components, T12[] t12Components, T13[] t13Components)
		where T0 : unmanaged
        where T1 : unmanaged
        where T2 : unmanaged
        where T3 : unmanaged
        ...
        where T13 : unmanaged
	{
		Set(entityId, t0Components.AsSpan(), t1Components.AsSpan(), t2Components.AsSpan(), t3Components.AsSpan(), t4Components.AsSpan(), t5Components.AsSpan(), t6Components.AsSpan(), t7Components.AsSpan(), t8Components.AsSpan(), t9Components.AsSpan(), t10Components.AsSpan(), t11Components.AsSpan(), t12Components.AsSpan(), t13Components.AsSpan());
	}
	/// <inheritdoc cref="Set{T0}(Entity, ReadOnlySpan{T0})"/>
	[ChunkChange]
	...
	/// <inheritdoc cref="Set{T0}(int, T0[])"/>
	[ChunkChange]
	public void Set<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>(int entityId, T0[] t0Components, T1[] t1Components, T2[] t2Components, T3[] t3Components, T4[] t4Components, T5[] t5Components, T6[] t6Components, T7[] t7Components, T8[] t8Components, T9[] t9Components, T10[] t10Components, T11[] t11Components, T12[] t12Components, T13[] t13Components, T14[] t14Components)
		where T0 : unmanaged
        where T1 : unmanaged
        where T2 : unmanaged
        where T3 : unmanaged
	...
	/// <inheritdoc cref="Set{T0}(int, T0[])"/>
	[ChunkChange]
	public void Set<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15>(int entityId, T0[] t0Components, T1[] t1Components, T2[] t2Components, T3[] t3Components, T4[] t4Components, T5[] t5Components, T6[] t6Components, T7[] t7Components, T8[] t8Components, T9[] t9Components, T10[] t10Components, T11[] t11Components, T12[] t12Components, T13[] t13Components, T14[] t14Components, T15[] t15Components)
		where T0 : unmanaged
        where T1 : unmanaged
        where T2 : unmanaged
        where T3 : unmanaged
