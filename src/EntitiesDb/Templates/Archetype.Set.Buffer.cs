...
public partial class Archetype
{
        ...
        where T1 : unmanaged
	{
		...
		chunk.Set(slot.Index, in offsets, t0Components, t1Components);
	}
	/// <inheritdoc cref="Set{T0}(in EntitySlot, in Ids{T0}, ReadOnlySpan{T0})"/>
        ...
        where T2 : unmanaged
	{
		ref var chunk = ref _chunks[slot.ChunkIndex];
		var offsets = GetOffsets(in ids);
		chunk.Set(slot.Index, in offsets, t0Components, t1Components, t2Components);
	}
	/// <inheritdoc cref="Set{T0}(in EntitySlot, in Ids{T0}, ReadOnlySpan{T0})"/>
        ...
        where T3 : unmanaged
	{
		ref var chunk = ref _chunks[slot.ChunkIndex];
		var offsets = GetOffsets(in ids);
		chunk.Set(slot.Index, in offsets, t0Components, t1Components, t2Components, t3Components);
	}
	/// <inheritdoc cref="Set{T0}(in EntitySlot, in Ids{T0}, ReadOnlySpan{T0})"/>
        ...
        where T4 : unmanaged
	{
		ref var chunk = ref _chunks[slot.ChunkIndex];
		var offsets = GetOffsets(in ids);
		chunk.Set(slot.Index, in offsets, t0Components, t1Components, t2Components, t3Components, t4Components);
	}
	/// <inheritdoc cref="Set{T0}(in EntitySlot, in Ids{T0}, ReadOnlySpan{T0})"/>
        ...
        where T5 : unmanaged
	{
		ref var chunk = ref _chunks[slot.ChunkIndex];
		var offsets = GetOffsets(in ids);
		chunk.Set(slot.Index, in offsets, t0Components, t1Components, t2Components, t3Components, t4Components, t5Components);
	}
	/// <inheritdoc cref="Set{T0}(in EntitySlot, in Ids{T0}, ReadOnlySpan{T0})"/>
        ...
        where T6 : unmanaged
	{
		ref var chunk = ref _chunks[slot.ChunkIndex];
		var offsets = GetOffsets(in ids);
		chunk.Set(slot.Index, in offsets, t0Components, t1Components, t2Components, t3Components, t4Components, t5Components, t6Components);
	}
	/// <inheritdoc cref="Set{T0}(in EntitySlot, in Ids{T0}, ReadOnlySpan{T0})"/>
        ...
        where T7 : unmanaged
	{
		ref var chunk = ref _chunks[slot.ChunkIndex];
		var offsets = GetOffsets(in ids);
		chunk.Set(slot.Index, in offsets, t0Components, t1Components, t2Components, t3Components, t4Components, t5Components, t6Components, t7Components);
	}
	/// <inheritdoc cref="Set{T0}(in EntitySlot, in Ids{T0}, ReadOnlySpan{T0})"/>
        ...
        where T8 : unmanaged
	{
		ref var chunk = ref _chunks[slot.ChunkIndex];
		var offsets = GetOffsets(in ids);
		chunk.Set(slot.Index, in offsets, t0Components, t1Components, t2Components, t3Components, t4Components, t5Components, t6Components, t7Components, t8Components);
	}
	/// <inheritdoc cref="Set{T0}(in EntitySlot, in Ids{T0}, ReadOnlySpan{T0})"/>
        ...
        where T9 : unmanaged
	{
		ref var chunk = ref _chunks[slot.ChunkIndex];
		var offsets = GetOffsets(in ids);
		chunk.Set(slot.Index, in offsets, t0Components, t1Components, t2Components, t3Components, t4Components, t5Components, t6Components, t7Components, t8Components, t9Components);
	}
	/// <inheritdoc cref="Set{T0}(in EntitySlot, in Ids{T0}, ReadOnlySpan{T0})"/>
        ...
        where T10 : unmanaged
	{
		ref var chunk = ref _chunks[slot.ChunkIndex];
		var offsets = GetOffsets(in ids);
		chunk.Set(slot.Index, in offsets, t0Components, t1Components, t2Components, t3Components, t4Components, t5Components, t6Components, t7Components, t8Components, t9Components, t10Components);
	}
	/// <inheritdoc cref="Set{T0}(in EntitySlot, in Ids{T0}, ReadOnlySpan{T0})"/>
        ...
        where T11 : unmanaged
	{
		ref var chunk = ref _chunks[slot.ChunkIndex];
		var offsets = GetOffsets(in ids);
		chunk.Set(slot.Index, in offsets, t0Components, t1Components, t2Components, t3Components, t4Components, t5Components, t6Components, t7Components, t8Components, t9Components, t10Components, t11Components);
	}
	/// <inheritdoc cref="Set{T0}(in EntitySlot, in Ids{T0}, ReadOnlySpan{T0})"/>
        ...
        where T12 : unmanaged
	{
		ref var chunk = ref _chunks[slot.ChunkIndex];
		var offsets = GetOffsets(in ids);
		chunk.Set(slot.Index, in offsets, t0Components, t1Components, t2Components, t3Components, t4Components, t5Components, t6Components, t7Components, t8Components, t9Components, t10Components, t11Components, t12Components);
	}
	/// <inheritdoc cref="Set{T0}(in EntitySlot, in Ids{T0}, ReadOnlySpan{T0})"/>
        ...
        where T13 : unmanaged
	{
		ref var chunk = ref _chunks[slot.ChunkIndex];
		var offsets = GetOffsets(in ids);
		chunk.Set(slot.Index, in offsets, t0Components, t1Components, t2Components, t3Components, t4Components, t5Components, t6Components, t7Components, t8Components, t9Components, t10Components, t11Components, t12Components, t13Components);
	}
	/// <inheritdoc cref="Set{T0}(in EntitySlot, in Ids{T0}, ReadOnlySpan{T0})"/>
        ...
        where T14 : unmanaged
	{
		ref var chunk = ref _chunks[slot.ChunkIndex];
		var offsets = GetOffsets(in ids);
		chunk.Set(slot.Index, in offsets, t0Components, t1Components, t2Components, t3Components, t4Components, t5Components, t6Components, t7Components, t8Components, t9Components, t10Components, t11Components, t12Components, t13Components, t14Components);
	}
	/// <inheritdoc cref="Set{T0}(in EntitySlot, in Ids{T0}, ReadOnlySpan{T0})"/>
        ...
        where T15 : unmanaged
	{
		ref var chunk = ref _chunks[slot.ChunkIndex];
		var offsets = GetOffsets(in ids);
		chunk.Set(slot.Index, in offsets, t0Components, t1Components, t2Components, t3Components, t4Components, t5Components, t6Components, t7Components, t8Components, t9Components, t10Components, t11Components, t12Components, t13Components, t14Components, t15Components);
	}
}