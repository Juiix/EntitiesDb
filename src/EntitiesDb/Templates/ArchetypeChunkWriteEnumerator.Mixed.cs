	...
	where T1 : unmanaged
{
	...
	[SkipLocalsInit]
	public ArchetypeChunkWriteMixed1Enumerator(Span<Archetype> archetypes, ChangeFilter? changeFilter, int? compareVersion)
	{
	...
	where T2 : unmanaged
{
	...
	[SkipLocalsInit]
	public ArchetypeChunkWriteMixed2Enumerator(Span<Archetype> archetypes, ChangeFilter? changeFilter, int? compareVersion)
	{
		_archetypes = new ArchetypeEnumerator(archetypes);
		_changeFilter = changeFilter;
		_compareVersion = compareVersion ?? _changeFilter?.Version ?? 0;
	...
	where T3 : unmanaged
{
	...
	[SkipLocalsInit]
	public ArchetypeChunkWriteMixed3Enumerator(Span<Archetype> archetypes, ChangeFilter? changeFilter, int? compareVersion)
	{
		_archetypes = new ArchetypeEnumerator(archetypes);
		_changeFilter = changeFilter;
		_compareVersion = compareVersion ?? _changeFilter?.Version ?? 0;
	...
	where T4 : unmanaged
{
	...
	[SkipLocalsInit]
	public ArchetypeChunkWriteMixed4Enumerator(Span<Archetype> archetypes, ChangeFilter? changeFilter, int? compareVersion)
	{
		_archetypes = new ArchetypeEnumerator(archetypes);
		_changeFilter = changeFilter;
		_compareVersion = compareVersion ?? _changeFilter?.Version ?? 0;
	...
	where T5 : unmanaged
{
	...
	[SkipLocalsInit]
	public ArchetypeChunkWriteMixed5Enumerator(Span<Archetype> archetypes, ChangeFilter? changeFilter, int? compareVersion)
	{
		_archetypes = new ArchetypeEnumerator(archetypes);
		_changeFilter = changeFilter;
		_compareVersion = compareVersion ?? _changeFilter?.Version ?? 0;
	...
	where T6 : unmanaged
{
	...
	[SkipLocalsInit]
	public ArchetypeChunkWriteMixed6Enumerator(Span<Archetype> archetypes, ChangeFilter? changeFilter, int? compareVersion)
	{
		_archetypes = new ArchetypeEnumerator(archetypes);
		_changeFilter = changeFilter;
		_compareVersion = compareVersion ?? _changeFilter?.Version ?? 0;
	...
	where T7 : unmanaged
{
	...
	[SkipLocalsInit]
	public ArchetypeChunkWriteMixed7Enumerator(Span<Archetype> archetypes, ChangeFilter? changeFilter, int? compareVersion)
	{
		_archetypes = new ArchetypeEnumerator(archetypes);
		_changeFilter = changeFilter;
		_compareVersion = compareVersion ?? _changeFilter?.Version ?? 0;
	...
	where T8 : unmanaged
{
	...
	[SkipLocalsInit]
	public ArchetypeChunkWriteMixed8Enumerator(Span<Archetype> archetypes, ChangeFilter? changeFilter, int? compareVersion)
	{
		_archetypes = new ArchetypeEnumerator(archetypes);
		_changeFilter = changeFilter;
		_compareVersion = compareVersion ?? _changeFilter?.Version ?? 0;
	...
	where T9 : unmanaged
{
	...
	[SkipLocalsInit]
	public ArchetypeChunkWriteMixed9Enumerator(Span<Archetype> archetypes, ChangeFilter? changeFilter, int? compareVersion)
	{
		_archetypes = new ArchetypeEnumerator(archetypes);
		_changeFilter = changeFilter;
		_compareVersion = compareVersion ?? _changeFilter?.Version ?? 0;
